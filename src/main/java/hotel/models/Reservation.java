...
public class Reservation {
    ...
    /**
     * Adds an extra amenity to this reservation.
     * Validates: amenity must not already be in extra list, and must not be
     * one of the room's fixed amenities (checked via the room reference passed in).
     *
     * @param amenity        the amenity to add
     * @param roomAmenities  the fixed amenities already on the room
     * @param nights         number of nights – used to recalculate total cost
     * @throws IllegalArgumentException if amenity is already present (fixed or extra)
     */
